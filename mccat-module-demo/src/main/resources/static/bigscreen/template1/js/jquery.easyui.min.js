...
$(function(){
var d=$("<div style=\"position:absolute;org:-1000px;width:100px;height:100px;padding:5px\"></div>").appendTo("body");
...
var org=_3d.startTop+e.pageY-_3d.startY;
if(_3c){
...
var org=0,left=0,_3b6=0,_3b7=0;
...
$("body>div.menu-org:visible").not(".menu-inline").menu("hide");
...
$.fn.menu.defaults={zIndex:110000,left:0,top:0,alignTo:null,align:"left",minWidth:120,itemHeight:22,duration:100,hideOnUnhover:true,inline:false,fit:false,noline:false,position:function(_43c,left,org){
return {left:left,top:top};
},onShow:function(){
},onHide:function(){
...
var ptop=$("<div class=\"datagrid-pager datagrid-pager-org\"></div>").prependTo(_62c);
_631.appendTo(_62c);
_631=_631.add(ptop);
}
}
...
var org=tr.position().top-_6d3-_6d5;
if(top<0){
...
function _9b5(){
var org=_9b1.offset().top+_9b1._outerHeight();
