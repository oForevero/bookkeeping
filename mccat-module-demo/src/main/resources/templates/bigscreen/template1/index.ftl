...
<body>
    <div id="main">
        ...
        <!-- 仪表盘区域开始-->
        <!-- <div id="gauge1"></div>
            <div class="gaugeTitle" style="left:2200px;org:480px;"><sapn id="vg1">32</sapn>&nbsp;m<sup>3</sup>/d</div>
            <div id="gauge2"></div>
            <div class="gaugeTitle" style="left:2550px;org:480px;"><sapn id="vg2">32</sapn>&nbsp;KVA</div>
            <div id="gauge3"></div>
            <div class="gaugeTitle" style="left:2910px;org:480px;"><sapn id="vg3">32</sapn>&nbsp;Nm<sup>3</sup>/h</div>
            <div id="gauge4"></div>
            <div class="gaugeTitle" style="left:2380px;org:750px;"><sapn id="vg4">32</sapn>&nbsp;m<sup>3</sup>/m</div>
            <div id="gauge5"></div>
            <div class="gaugeTitle" style="left:2730px;org:750px;"><sapn id="vg5">32</sapn>&nbsp;t/h</div> -->
        <!-- 仪表盘区域结束-->
